...
// underscore. Case is preserved and runs are NOT collapsed, so "a..b" is "a__b".
...
//
// Identical to formClaudeCode but for one character class: a hyphen is NOT legal
// here and folds to an underscore, which is why a hyphenated Codex server key
// never matches its own configuration exactly. Codex applies this to the tool half
// as well.
//
